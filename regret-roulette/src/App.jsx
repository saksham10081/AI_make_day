...
// --- DATASET: ICONIC INDIAN REGRETS (with storyboard narratives) ---
const REGRET_DATA = [
  {
    id: 'rel_blr_01',
...
const SpinningStage = ({ targetRotation, item, onComplete }) => {
  ...
  return (
    ...
    >
      ...
      {/* Dramatic reveal overlay after wheel stops */}
      <AnimatePresence>
        {showResult && (
          <motion.div
            initial={{ opacity: 0 }}
    ...
    >
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className={`flex-1 flex flex-col justify-between p-8 md:p-16 bg-gradient-to-b ${scene.gradient}`}
        >
...
const App = () => {
  ...
  const handleReset = () => setStage('landing');
